...
contextBridge.exposeInMainWorld('mainAPI', {
    ...
    onShowVisit4: (callback) => ipcRenderer.on('show-visit-4', callback),
    ...
    regimesForVisit4: async(condition, stage) => await ipcRenderer.invoke('regimes-for-visit-4', condition, stage),
